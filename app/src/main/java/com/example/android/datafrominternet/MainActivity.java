...
public class MainActivity extends AppCompatActivity {
    ...
    public void makeGithubSearchQuery(){
        String githubSearchQuery = mSearchBoxEditText.getText().toString().toLowerCase().trim();
        URL gitHubQueryUrl = NetworkUtils.buildUrl(githubSearchQuery, getApplicationContext());
        mUrlDisplayTextView.setText(gitHubQueryUrl.toString());
        Toast.makeText(MainActivity.this,"this is query URL: " + gitHubQueryUrl.toString(), Toast.LENGTH_SHORT).show();
    }
